    ...
    <div className="p-6 bg-gray-50 min-h-screen font-sans text-slate-700">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-800">Migrant Help</h1>
            <div className="flex items-center gap-2 text-sm text-gray-400 mt-1">
              <span>Operation Hub</span> / <span className="text-slate-600 font-medium">Migrant Help</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
            ...
            <div><div className="text-sm font-medium text-slate-500">Migrant Help</div><div className="text-3xl font-bold text-slate-800 mt-1">{stats.total}</div></div>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
            ...
            <div><div className="text-sm font-medium text-slate-500">Urgent Needs</div><div className="text-3xl font-bold text-slate-800 mt-1">{stats.pending}</div></div>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
            ...
            <div><div className="text-sm font-medium text-slate-500">Housing Support</div><div className="text-3xl font-bold text-slate-800 mt-1">{stats.completed}</div></div>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
            ...
            <div><div className="text-sm font-medium text-slate-500">Wellbeing Checks</div><div className="text-3xl font-bold text-slate-800 mt-1">{stats.actionRequired}</div></div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200">
          <div className="p-5 border-b border-slate-100 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div><h3 className="text-lg font-bold text-slate-800">Tasks List</h3><div className="text-sm text-gray-400 mt-1">{stats.total} total records</div></div>
            <div className="flex flex-wrap items-center gap-3">
              <div className="relative">
                <input type="text" placeholder="Search Tasks..." className="pl-10 pr-4 py-2 border border-slate-200 rounded text-sm w-64 focus:outline-none focus:border-slate-400" />
              ...
              <button onClick={openNewInspection} className="bg-[#e77a40] hover:bg-[#d66a30] text-white px-4 py-2 rounded shadow-sm text-sm font-medium flex items-center gap-2 transition-colors">Create Task</button>
            </div>
          </div>
              ...
              <tbody className="text-sm">
                {loading ? (
                  ...
                  <tr key={r.id ?? r.reference} className="border-b border-slate-50 hover:bg-slate-50 group transition-colors">
                    ...
                    <td className="p-5 align-top pt-6"><span className="bg-orange-50 text-orange-500 border border-orange-100 px-3 py-1 rounded-full text-[11px] font-bold tracking-wide">Migrant Help</span></td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl overflow-hidden">
            <div className="flex justify-between items-start p-6 border-b border-slate-100">
              <div>
                <h2 className="text-xl font-bold text-slate-800">Migrant Help Task</h2>
            ...
            <form onSubmit={handleSubmit} className="p-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input type="text" name="inspectorName" required value={formData.inspectorName} onChange={handleInputChange} placeholder="Brief description of task" className="w-full border border-slate-300 rounded px-3 py-2.5 text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500 outline-none" />
                </div>

                  {/* Row 4 */}
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-1.5">Description</label>
                  <textarea name="findings" rows={3} value={formData.findings} onChange={handleInputChange} placeholder="Detailed desription of the task..." className="w-full border border-slate-300 rounded px-3 py-2.5 text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500 outline-none resize-none" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" name="inspectorName" required value={formData.inspectorName} onChange={handleInputChange} placeholder="Name of person reporting" className="w-full border border-slate-300 rounded px-3 py-2.5 text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500 outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-1.5">Reported Date <span className="text-red-500">*</span></label>
