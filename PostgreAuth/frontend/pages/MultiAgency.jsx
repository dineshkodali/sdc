    ...
    <div className="p-6 bg-gray-50 min-h-screen font-sans text-slate-700">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-800">Multi-Agency</h1>
            <div className="flex items-center gap-2 text-sm text-slate-500 mt-1">
                <IconHome size={14} /> <span>/</span> <span>Operation Hub</span> <span>/</span><span>Safeguarding</span> <span>/</span> <span className="text-slate-800 font-medium">Multi-Agency</span>
              </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200">
          <div className="p-5 border-b border-slate-100 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button onClick={openNewInspection} className="bg-[#e77a40] hover:bg-[#d66a30] text-white px-4 py-2 rounded shadow-sm text-sm font-medium flex items-center gap-2 transition-colors">Create Referral</button>
            </div>
          </div>
              ...
              <tbody className="text-sm">
                {loading ? (
                  ...
                  <tr key={r.id ?? r.reference} className="border-b border-slate-50 hover:bg-slate-50 group transition-colors">
                    ...
                    <td className="p-5 align-top pt-6"><span className="bg-orange-50 text-orange-500 border border-orange-100 px-3 py-1 rounded-full text-[11px] font-bold tracking-wide">Multi Agency</span></td>
