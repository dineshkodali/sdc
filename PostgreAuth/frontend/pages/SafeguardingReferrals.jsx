...
export default function SafeguardingReferrals() {
  ...
  const handleDelete = async (id) => {
    const ok = window.confirm(
      "Delete this referral? This action cannot be undone."
    );
    if (!ok) return;
    try {
      ...
      window.alert("Unable to delete referral. See console for details.");
    }
  };
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500 mt-1">
              <IconHome size={14} /> <span>/</span> <span>Operation Hub</span>{" "}
              <span>/</span>
              <span>Safeguarding</span> <span>/</span>{" "}
          ...
          >
            <span className="text-lg leading-none">+</span> New Referral
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
            <div className="w-14 h-14 rounded-full flex items-center justify-center text-white bg-blue-500 shadow-blue-100">
              <IconClipboard />
            </div>
            <div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm flex items-center gap-5">
            <div className="w-14 h-14 rounded-full flex items-center justify-center text-white bg-pink-500 shadow-pink-100">
              <IconAlert />
            </div>
            <div>
