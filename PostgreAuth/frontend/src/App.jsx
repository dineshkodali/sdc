...
import PPARFileUpload from "../pages/PPARFileUpload";
...
import MigrantHelp from "../pages/MigrantHelp";
...
// --- ADDED: Escalations Module page import ---
import Complaints from "../pages/ComplaintsList";
import VCSOrganizations from "../pages/VCSOrganizations";
import CaseManagement from "../pages/CaseManagement";
import EmergencyProtocols from "../pages/EmergencyProtocols";
// --- ADDED: HSE Module page import ---
...
const PPARFileUploadSafe = makeSafe(PPARFileUpload, "PPARFileUpload");
...
// --- ADDED: safe wrapper for HSE Module page ---
const HSEIncidentsSafe = makeSafe(HSEIncidents, "HSEIncidents");
const RiskManagementSafe = makeSafe(RiskManagement, "RiskManagement");
const TrainingSafe = makeSafe(Training, "Training");
const AuditSafe = makeSafe(Audit, "Audit");
/* --------------------------
   Error boundary
   -------------------------- */
              ...
              <Route path="/admin/*" element={
                 <AdminLayoutWrapper>
                   <Routes>
                      ...
                      <Route path="bookings" element={<BookingsSafe user={user}/>} />
                      ...
                      <Route path="maintenance" element={<MaintenancePageSafe user={user} />} />

                      {/* --- Inspections route --- */}
                      <Route path="inspections" element={<InspectionsSafe user={user} />} />

                      {/* --- Incidents route --- */}
                      <Route path="incidents" element={<IncidentsSafe user={user} />} />

                      {/* --- ADDED: Compliance route under admin --- */}
                      <Route path="compliance" element={<ComplianceSafe user={user} />} />

                      {/* --- AIRE Tasks route --- */}
                      <Route path="aire-tasks" element={<AIRETasksSafe user={user} />} />
                      {/* --- Migrant Help Tasks route --- */}
                      <Route path="migranthelp" element={<MigrantHelpSafe user={user} />} />
                       {/* --- Migrant Help Tasks route --- */}
                      <Route path="safeguarding/referrals" element={<SafeguardingReferralsSafe user={user} />} />
                      <Route path="safeguarding/risk-assessment" element={<RiskAssessmentSafe user={user} />} />
                      <Route path="safeguarding/vulnerable-users" element={<VulnerableUsersSafe user={user} />} />
                      <Route path="safeguarding/multi-agency" element={<MultiAgencySafe user={user} />} />

                      {/* --- Complaints Tasks route --- */}
                      <Route path="complaints" element={<ComplaintsSafe user={user} />} />
                      {/* --- VCS Organizations route --- */}
                      <Route path="vcsorganizations" element={<VCSOrganizationsSafe user={user} />} />

                      {/* --- Case Management route --- */}
                      <Route path="casemanagement" element={<CaseManagementSafe user={user} />} />
                      {/* --- Emergency Protocols route --- */}
                      <Route path="emergencyprotocols" element={<EmergencyProtocolsSafe user={user} />} />


                      {/* --- HSE Incidents route --- */}
                      <Route path="hseincidents" element={<HSEIncidentsSafe user={user} />} />
                      {/* --- Risk Management route --- */}
                      <Route path="riskmanagement" element={<RiskManagementSafe user={user} />} />

                      {/* --- Training route --- */}
                      <Route path="training" element={<TrainingSafe user={user} />} />
                      {/* --- Audits route --- */}
                      <Route path="audits" element={<AuditSafe user={user} />} />
